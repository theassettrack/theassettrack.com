      ...
      <main>
          ...
          <div className="lg:flex lg:items-center lg:gap-12">
            <div className="lg:w-[45%]">
              ...
              <a 
                ...
                className="inline-flex items-center rounded-full border border-asset-border dark:border-asset-border-dark bg-transparent px-2 py-1 mb-6 hover:bg-asset-border/30 dark:hover:bg-asset-border-dark/30 transition-colors duration-200 cursor-pointer"
              >
                <span className="text-xs font-mono text-asset-gray dark:text-asset-gray-dark">{t('header.badge')}</span>
                <ExternalLink className="w-3 h-3 ml-1 text-asset-gray dark:text-asset-gray-dark" />
              </a>
              
              {/* Main Heading - Exact from original */}
              <h1 className="text-[34px] sm:text-[40px] md:text-[48px] font-mono leading-[104%] text-asset-dark dark:text-asset-dark-dark mb-4 max-w-[450px]" style={{fontWeight: 400}}>
                {t('hero.title')}
              </h1>
              
              {/* Subtitle - Exact from original */}
              <p className="text-[16px] font-mono text-asset-gray dark:text-asset-gray-dark mb-4 leading-relaxed max-w-[350px]" style={{fontWeight: 500}}>
                {t('hero.subtitle')}
              </p>
        ...
        <Section variant="default" backgroundPattern="noise" className="px-[40px] sm:px-[60px] md:px-[80px]">
          <div className="space-y-[80px]">
            ...
            <div className="text-center">
              <h2 className="text-[34px] sm:text-[40px] md:text-[2rem] font-mono text-asset-dark dark:text-asset-dark-dark" style={{fontWeight: 400}}>
                {t('services.title')}
              </h2>
            </div>
            ...
            {services.map((service, index) => (
              ...
              >
                ...
                <div className="lg:w-1/2 space-y-[16px]">
                  <h3 className="text-[1.5rem] font-mono text-asset-medium dark:text-asset-medium-dark" style={{fontWeight: 400}}>
                    {service.title}
                  </h3>
                  <p className="text-[18px] font-mono text-asset-medium dark:text-asset-medium-dark leading-[150%]" style={{fontWeight: 400}}>
                    <strong>{service.description}</strong>
                  </p>
                  <ul className="space-y-[12px]">
                    {service.features.map((feature, idx) => (
                      <li key={idx} className="flex items-start gap-[12px] text-asset-medium dark:text-asset-medium-dark">
                        <div className="w-1.5 h-1.5 bg-asset-blue dark:bg-asset-blue-dark rounded-full flex-shrink-0 mt-2" />
        ...
        <Section variant="default" backgroundPattern="noise" className="px-[40px] sm:px-[60px] md:px-[80px]">
          <div className="text-center space-y-[50px]">
            <div>
              <h2 className="text-[34px] sm:text-[40px] md:text-[2rem] font-mono text-asset-dark dark:text-asset-dark-dark mb-8 sm:mb-12 md:mb-16" style={{fontWeight: 400}}>
                {t('about.title')}
              </h2>
            </div>
            ...
            <div className="flex flex-col lg:flex-row items-start lg:items-center gap-[40px] sm:gap-[50px] md:gap-[60px] lg:gap-[80px]">
              ...
              <div className="flex flex-col items-center text-center lg:w-1/3">
                <div className="w-32 h-32 sm:w-40 sm:h-40 md:w-48 md:h-48 rounded-full overflow-hidden bg-asset-blue dark:bg-asset-blue-dark mb-4 sm:mb-6 relative ring-2 ring-asset-border dark:ring-asset-border-dark">
                  <img 
                ...
                <div className="space-y-[8px]">
                  <p className="font-mono text-asset-dark dark:text-asset-dark-dark" style={{fontWeight: 600}}>
                    <strong>{t('about.name')}</strong>
                  </p>
                  <p className="font-mono text-asset-gray dark:text-asset-gray-dark" style={{fontWeight: 400}}>
                    {t('about.role')}
                  </p>
                </div>
              </div>
              ...
              <div className="lg:w-2/3 text-left">
                <h3 className="text-[1.5rem] font-mono text-asset-dark dark:text-asset-dark-dark mb-4 sm:mb-6" style={{fontWeight: 400}}>
                  {t('about.sectionTitle')}
                </h3>
                <div className="space-y-6 text-[16px] font-mono text-asset-gray dark:text-asset-gray-dark leading-relaxed" style={{fontWeight: 400}}>
        ...
        <Section variant="default" backgroundPattern="noise" className="px-[40px] sm:px-[60px] md:px-[80px]">
          <div className="text-center space-y-[32px]">
            <h2 className="text-2xl md:text-3xl font-mono font-bold text-asset-dark dark:text-asset-dark-dark">
              {t('finalCta.title')}
            </h2>
            <p className="text-[16px] md:text-[18px] text-asset-gray dark:text-asset-gray-dark max-w-2xl mx-auto">
              {t('finalCta.subtitle')}
            </p>
            <Button 
              variant="asset-primary" 
